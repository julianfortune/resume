...
experience to a customer loyalty application to compliment matches for a
top national soccer league.

\begin{itemize}
\tightlist
\item
  Wrote Postgres migrations, implemented endpoints, added new front-end
  features, and developed components using Radix UI and Tailwind CSS.
\item
